...
public class ExceptionHandlerControllerAdvice {
	...
	/*
	 * @ExceptionHandler(RestLoginErrorException.class) public @ResponseBody
	 * ResponseDto<?> handleRestLoginErrorException(RestLoginErrorException e, Model
	 * model){
	 * 
	 * ResponseDto<?> response = new ResponseDto<>(); response.setStatus("FAIL");
