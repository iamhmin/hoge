...
<main id="main">
  ...
  <h1 class="section__title">숙소 할인 프로모션 (종료)</h1>
  <form
 ...
 <article id="admin-user">
 <h1 class="section__title">숙소 증정 프로모션 (종료)</h1>
  <form
      class="search-user__form review"
      id="form-search-userQnA"
      method="get"
 ...
 <article id="admin-user">
 <h1 class="section__title">체험 할인 프로모션 (종료)</h1>
  <form
      class="search-user__form review"
      id="form-search-userQnA"
      method="get"
 ...
 <article id="admin-user">
 <h1 class="section__title">체험 증정 프로모션 (종료)</h1>
  <form
      class="search-user__form review"
      id="form-search-userQnA"
      method="get"
...
function searchAccDiscountPromotions(page) {
	...
	var order =  $("select[name=order]").val();
			...
			$.ajax({
				type: 'POST',
				url : "/admin/searchEndedAccDiscountPromotions.do", //서비스 주소 
...
function searchAccOfferPromotions(page) {
	...
	var order =  $("select[name=order1]").val();
			...
			$.ajax({
				type: 'POST',
				url : "/admin/searchEndedAccOfferPromotions.do", //서비스 주소 
				data : { //서비스 처리에 필요한 인자값
					page : page,
					opt : opt,
					value : value,
...
function searchActDiscountPromotions(page) {
	...
	var order =  $("select[name=order2]").val();
			...
			$.ajax({
				type: 'POST',
				url : "/admin/searchEndedActDiscountPromotions.do", //서비스 주소 
				data : { //서비스 처리에 필요한 인자값
					page : page,
					opt : opt,
					value : value,
...
function searchActOfferPromotions(page) {
	...
	var order =  $("select[name=order3]").val();
			...
			$.ajax({
				type: 'POST',
				url : "/admin/searchEndedActOfferPromotions.do", //서비스 주소 
				data : { //서비스 처리에 필요한 인자값
					page : page,
					opt : opt,
					value : value,
