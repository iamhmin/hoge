...
<body>
	<form class="border p-3 bg-light" id="" method="post" action="addTime" enctype="multipart/form-data">
			...
			<div class="row mb-3 d-flex justify-content-center">
				<div class="col-6 text-center">
					...
					<div class="mb-3">
						...
						<!-- <input type="hidden" value="" id="b" name="time" />  -->
						
					<div class="mb-3 text-end">
						<button class="btn btn-primary" type="submit">타임테이블 등록</button>
					</div>
				</div>
			</div>
		</div>
